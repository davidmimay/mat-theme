...
export class RenderService {
  ...
  // Algorithm from https://github.com/mbitson/mcg/blob/master/scripts/controllers/ColorGeneratorCtrl.js#L237, (MIT)
...
$theme-${name}: ${theme.version >= 12 ? `mat.define-palette` : 'mat-palette'}($mat-${name}, main, lighter, darker);`
  ...
  static getTemplate(theme: Theme) {
    ...
    const tpl = `
// MAT-THEME created at: https://mat-theme.web.app
// edit your theme at: ${this.toExternalLink(theme)}
